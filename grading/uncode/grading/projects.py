...
class VerilogProjectFactory(ProjectFactory):
    ...
    def create_from_directory(self, directory):
        def build():
            ...
            compilation_command = ["iverilog -o golden.out"] + self._additional_flags
            compilation_command.extend(golden_file)
            compilation_command.extend(testbench_file)
            ...
            compilation_command.extend(testbench_file)
            compilation_command.extend(design_file)
